...
<footer id="footer" class="footer__boys">
    <div class="container">
        <div class="inner">
            <div class="row footer__top__boys ">
                <div class="col-lg-3 col-sm-6">
                    <div>
                        <img src="<?php echo get_template_directory_uri() . '/images/footer-icon.png' ?>" alt="">
                    </div>
                    <div class="footer__boys__email">
                        <a href="">info.boys@myqca.org</a>
                    </div>
                    <p>+1 (469) 929 9950</p>
                </div>
                <div class="col-lg-2 col-sm-3">
                    <p class="pages-title-boys">Pages</p>
                    <p>Courses</p>
                    <p>Admission</p>
                    <p>Boys</p>
                    <p>Girls</p>
                ...
                <div class="col-lg-2 col-sm-3">
                    <p class="page-links-boys">Links</p>
                    <p>About us</p>
                    <p>Contacts</p>
                </div>
                <div class="col-lg-5">
                    <div class="newsletter-footer-boys">
