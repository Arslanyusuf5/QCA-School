<section class="color__code">
    <div class="container-fluid">
        <div class="row">
            <div class="color__code__slider">
                <div class="swiper swiper-container colorcodeslider">
                    <div class="swiper-wrapper">
                        <?php

                        $color_code_repeater = get_field('color_code_repeater');

                        if (have_rows('color_code_repeater')) :
                            while (have_rows('color_code_repeater')) : the_row();

                                $color_picker = get_sub_field('color_picker');
                                $color_picker_heading = get_sub_field('color_picker_heading');
                        ?>
                                <div class="swiper-slide">
                                    <div class="select__color">
                                        <div class="color__Wrap" style="background: <?php echo $color_picker; ?>;">
                                        </div>
                                    </div>
                                    <div class="color__heading"><?php echo $color_picker_heading; ?></div>
                                </div>
                        <?php
                            endwhile;
                        endif;
