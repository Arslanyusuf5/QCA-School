<section id="epic-gallery" class="epic-gallery pt-5 pb-5">
    <div class="epic-gallery-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 pb-5">
                    <div class="epic=gallery-title d-flex justify-content-center align-content-center">
                        <h1>Epic Gallery</h1>
                    </div>
                    <div class="epic-gallery-svg d-flex justify-content-center align-content-center pt-3 pb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="178" height="10" viewBox="0 0 178 10" fill="none">
                            <path d="M1 8.07718C49.5338 -0.011811 116.717 -0.685935 177.834 8.07718" stroke="#0089E8" stroke-width="2.24694" />
                        </svg>
                    </div>
                </div>
                <div class="col-12">
                        ...
                        <div class="swiper swiper-container mySwiperepicgallery">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo get_template_directory_uri() . '/images/epic-gallery-image-two.jpg' ?>" alt="Card image cap">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo get_template_directory_uri() . '/images/epic-gallery-image-one.jpg' ?>" alt="Card image cap">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo get_template_directory_uri() . '/images/epic-gallery-image-three.jpg' ?>" alt="Card image cap">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo get_template_directory_uri() . '/images/epic-gallery-image-four.jpg' ?>" alt="Card image cap">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card">
